...
export const Navbar = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[200] flex h-14 items-center justify-between bg-[rgba(246,244,239,0.92)] px-9 backdrop-blur-2xl transition-colors duration-300 border-b border-[var(--border)] dark:bg-[rgba(17,17,16,0.92)]">
